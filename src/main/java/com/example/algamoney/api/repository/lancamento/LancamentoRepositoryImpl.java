...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	@Override
	public List<LancamentoEstatisticaCategoria> consultaPorCategoria(LocalDate mesReferencia) {
		CriteriaBuilder builder = manager.getCriteriaBuilder();
		...
		criteria.where(builder.lessThanOrEqualTo(root.get(Lancamento_.dataVencimento), ultimoDia));
	...
	@Override
	public List<LancamentoEstatisticaDia> consultaPorDia(LocalDate mesReferencia) {
		CriteriaBuilder builder = manager.getCriteriaBuilder();
		...
		criteria.groupBy(root.get(Lancamento_.tipo), root.get(Lancamento_.tipo));
	...
	@Override
	public List<LancamentoEstatisticaPessoa> consultaPorPessoa(LocalDate incio, LocalDate fim) {
		CriteriaBuilder builder = manager.getCriteriaBuilder();
		...
		criteria.where(builder.greaterThanOrEqualTo(root.get(Lancamento_.dataVencimento), incio));
		criteria.where(builder.lessThanOrEqualTo(root.get(Lancamento_.dataVencimento), fim));
